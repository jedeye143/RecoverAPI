...
namespace RecoverPH_API.Migrations
{
    ...
    [Migration("20250923010956_RemoveSubscriptionFieldsFromApplicationUser")]
    partial class RemoveSubscriptionFieldsFromApplicationUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecoverPH_API.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RecoverPH_API.Models.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecoverPH_API.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecoverPH_API.Models.PaymentTransaction", b =>
                {
                    b.HasOne("RecoverPH_API.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
